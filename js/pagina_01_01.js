  ...
  function carregarDados() {
    ...
    for (let index = 0; index < 10; index++) {
        ...
        if (index < alunos.length) {
          row.insertCell(1).innerText = capitalizeFirstLetters(alunos[index].nomeAluno);
            ...
            row.insertCell(5).innerText = capitalizeFirstLetters(alunos[index].curso);
    ...
    document.getElementById("nomeDocente").innerText = capitalizeFirstLetters(professor);
  }
